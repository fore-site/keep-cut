...
export default function ResultsPage() {
  ...
  const [results, setResults] = useState<{ kept: Item[]; cut: Item[] } | null>(
    null,
  );
    ...
    <div className="space-y-12 animate-in fade-in zoom-in-95 duration-500">
      <div className="text-center space-y-4">
        ...
        <p className="opacity-60">
          You've made your choices. Here is your split.
        </p>
      </div>
...
function ResultColumn({
  ...
  return (
    <div className="space-y-6">
      <h2 className={`text-2xl font-black text-center text-${accent}`}>
        {title} ({items.length})
      </h2>
        ...
        {items.map((item, idx) => (
          ...
          >
            ...
            <div className="text-center">
              <div className="text-sm font-bold whitespace-normal break-words leading-snug px-1">
                {item.name}
              </div>
            </div>
          </motion.div>
